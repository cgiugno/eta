...
;```````````````````````````````````````````````````````````
; Lissa elderly Day 6 dialogue

:episodes (

?e1 ((set-of ^me ^you) have-household-chores-dialog.v)

?e2 ((set-of ^me ^you) have-money-dialog.v)

?e3 ((set-of ^me ^you) have-growing-older-dialog.v)
