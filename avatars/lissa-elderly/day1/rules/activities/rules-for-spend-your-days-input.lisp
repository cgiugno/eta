...
'(
  ...
  1 (0 library 0)
    2 ((I spend my days going to library \.)  (spend-your-days)) (0 :gist) 		
  1 (0 read 0) 
  ...
  1 (0 coffee shop 0)
    2 ((I spend my days going to coffee shop \.)  (spend-your-days)) (0 :gist)
	1 (0 NegMood 0)
    2 ((I spend my days in a boring way \.)  (spend-your-days)) (0 :gist)
	1 (0 lay down 0)
    2 ((I spend my days laying down \.)  (spend-your-days)) (0 :gist)
	1 (0 lay 2 bed 0)
    2 ((I spend my days laying down \.)  (spend-your-days)) (0 :gist)

	1 (0)
     2 ((NIL Gist \: nothing found for how I spend my days \.)  (spend-your-days)) (0 :gist)
))
...
'(
  ...
  1 (0 reading 0)
    2 (It is so great to keep my mind busy by reading books or magazines\.) (100 :out)
  1 (0 dancing 0)
    2 (You love dancing \. It makes me feel young and energetic \.) (100 :out)
  1 (0 friends 0)
  ...
  1 (0 library 0)
    2 (Oh\, library is a good choice. I get to meet people in library\.) (100 :out)
  1 (0 cooking 0)
  ...
  1 (0 coffee shop 0)
    2 (You would love to go to coffee shops but you haven\'t had the chance to try much of them around\.) (100 :out) 
	1 (0 boring 0)
    2 (There are a lot of fun things I can do around \. Especially when the weather is nice\, I can spend time outside and enjoy the weather \.) (100 :out) 
	1 (0 laying down 0)
	  2 (There are a lot of fun things I can do around \. Especially when the weather is nice\, I can spend time outside and enjoy the weather \.) (100 :out) 
