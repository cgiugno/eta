...
;```````````````````````````````````````````````````````````
; Lissa elderly Day 10 dialogue

:episodes (

?e1 ((set-of ^me ^you) have-home-dialog.v)

?e2 ((set-of ^me ^you) have-staying-active-dialog.v)

?e3 ((set-of ^me ^you) have-spirituality-dialog.v)
