;; *ETA-SCHEMA*: development version 7   [modified from Ben's June 5/20 version 6]
;;
...
:types
  ...
  !t4 (|Table| table.n)
  !t5 (|the Target Block| block.n)
  !t6 (|the Starbucks Block| block.n)
  !t7 (|the Twitter Block| block.n)
  !t8 (|the Texaco Block| block.n)
  !t9 (|the McDonald's Block| block.n)
  !t10 (|the Mercedes Block| block.n)
  !t11 (|the Toyota Block| block.n)
  !t12 (|the Burger King Block| block.n)

:rigid-conds
  !r1 (|the Target Block| (blue.a block.n))
  !r2 (|the Starbucks Block| (green.a block.n))
  !r3 (|the Twitter Block| (red.a block.n))
  !r4 (|the Texaco Block| (blue.a block.n))
  !r5 (|the McDonald's Block| (green.a block.n))
  !r6 (|the Mercedes Block| (red.a block.n))
  !r7 (|the Toyota Block| (blue.a block.n))
  !r8 (|the Burger King Block| (green.a block.n))
