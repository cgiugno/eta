...
;
  ...
  (MAPC 'ATTACHFEAT
	'((FINISH FINISHED DONE QUIT STOP TERMINATE)
	  ...
	  (DET THE A AN MY YOUR HIS HER ITS OUR THEIR ALL EVERY EACH ANY THIS
	       THESE THOSE THAT SOME MANY ONE TWO THREE ANOTHER OTHER WH-DET
	  ...
	  (DEG-ADV NOT JUST ONLY EXACTLY PRECISELY; name changed from 'WH-ADV' 6/17/19
